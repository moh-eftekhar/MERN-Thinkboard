import { PenSquare, PenSquareIcon, Trash, Trash2Icon } from "lucide-react";
...
const NoteCard = ({note, setNotes}) => {
    ...
    const handleDelete = async (e, id) =>{
        ...
        try {
            ...
            setNotes((prev) => prev.filter(note => note._id !== id)); // get rid of the delete note and refresh the page
